...
{
    std::cout << "Chatbot copying contents from an instance " << &obj << " to instance " << this << ".\n";
...
{
    std::cout << "Chatbot assigning contents from an instance " << &obj << " to instance " << this << ".\n";
...
{
    std::cout << "Chatbot moving (constructor) instance " << &obj << " to following instance " << this << ".\n";
...
{
    std::cout << "Chatbot moving (assignment) instance " << &obj << " to following instance " << this << ".\n";
    if(this == &obj) { return *this; }   
